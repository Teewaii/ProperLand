...
function Footer() {
    return (
        <section className="footer h-fit relative overflow-hidden">
            ...
            <div className="wrapper container mt-12 lg:mt-0 ">
                ...
                <div className="bottom flex  flex-row flex-wrap gap-[5px] items-start justify-between relative lg:border-b-2 lg:border-opacity-20 lg:border-primary lg:gap-[63px] lg:items-center ">
                    ...
                    <div className="cont  lg:border-l-2 lg:border-opacity-20 lg:border-primary lg:pl-20  ">
                        <div className="contact bg-secondary flex flex-col my-4 justify-center w-[400px] rounded-md lg:my-8  px-[45px] py-[25px]  ">
