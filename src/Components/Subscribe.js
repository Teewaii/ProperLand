...
function Subscribe() {
    return (
        <div className='flex flex-wrap items-center gap-3  '>
            <input type="email" name="email" id="email" placeholder='your email address here' className=' w-screen text-[13px] py-[13px] border-2 pl-4 rounded-sm focus:outline-none focus:shadow-md lg:w-[338px] ' />
