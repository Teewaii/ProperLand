...
function SeeArticles() {
    return (
        <div className='font-[600] text-sm xl:text-md bg-white flex items-center gap-x-2 w-fit px-4 py-3 group rounded-md hover:bg-primary hover:text-secondary cursor-pointer transition-all ease-in-out 300' >
            See All Articles
