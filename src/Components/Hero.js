                ...
                <div className="left_wrapper container flex items-start">
                    <div className="left pt-40 flex flex-col items-center lg:items-start relative lg:pt-[250px] xl:pt-[200px]  2xl:pt-[310px]">
                        ...
                        <div className="middle_text mb-2 xl:mb-2 2xl:mb-6">
                            <h1 className='text-[28px] md:text-[40px] md:leading-[50px] font-[600] md:max-w-[405px] lg:header2 leading-[35px]  lg:text-left xl:text-[50px] xl:max-w-[600px] xl:leading-[55px] 2xl:text-[65px] 2xl:max-w-[680px] 2xl:leading-[75px]'>Find the perfect place to Live with your family</h1>
                    ...
                    <div className="building rigt absolute right-0 bottom-0 lg:bottom-0">
                        <img className='h-[40vh]  md:h-[68vh] lg:h-[90vh] ' src={heroImg} alt="" />
                    </div>
                </div>
            </div>
        </section>
